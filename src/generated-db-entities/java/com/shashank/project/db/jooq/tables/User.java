...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The column <code>user.mobile_number</code>.
     */
    public final TableField<UserRecord, String> MOBILE_NUMBER = createField(DSL.name("mobile_number"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>user.is_active</code>.
     */
     ...
     */
    public final TableField<UserRecord, OffsetDateTime> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
     ...
     */
    public final TableField<UserRecord, UUID> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.UUID, this, "");

    /**
     * The column <code>user.updated_by</code>.
     */
    public final TableField<UserRecord, UUID> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.UUID, this, "");
